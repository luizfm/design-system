...
var withOutline = (StoryFn, context) => {
  let { globals: globals2 } = context, isActive = [true, "true"].includes(globals2[PARAM_KEY]), isInDocs = context.viewMode === "docs", outlineStyles = (0, import_preview_api.useMemo)(() => {
    let selector = isInDocs ? `#anchor--${context.id} .docs-story` : ".sb-show-main";
