...
declare const Heading: _stitches_react_types_styled_component.StyledComponent<"h2", {
    size?: "xxs" | "xs" | "sm" | "md" | "lg" | "2xl" | "4xl" | "5xl" | "6xl" | "3xl" | undefined;
}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
...
declare function TextInput({ prefix, ...inputProps }: TextInputProps): JSX.Element;
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextInput, TextInputProps, TextProps, Textarea, TextareaProps };
